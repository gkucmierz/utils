import { goldenRatio, goldenRatioBI } from '../src/golden-ratio.mjs';
...
describe('golden-ratio', () => {
  ...
  it('goldenRatioBI calculates to 30 decimal places correctly', () => {
    ...
    expect(phi.toString()).toEqual('1.618033988749894848204586834365');
  });
  ...
  it('goldenRatioBI works with 0 precision', () => {
    ...
    expect(phi.toString()).toEqual('1'); // sqrt(5*1) = 2. (2+1)/2 = 1.
  });
